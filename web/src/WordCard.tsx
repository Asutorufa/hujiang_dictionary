...
export default function WordCard({
  ...
  return (
    <article
      className={`app-word-card app-word-card-priority-${word.priority}`}
    >
      <div className="app-word-card-main">
          ...
          <div className="app-word-card-actions">
            ...
            <DropdownMenu.Root modal={false}>
              <DropdownMenu.Trigger>
                <button
                  type="button"
                  className="app-word-more"
                  aria-label={`More actions for ${word.word}`}
                >
                  <MoreVertIcon />
                </button>
              </DropdownMenu.Trigger>
        ...
        <div className="app-word-card-content">
          ...
          <section
            className={`app-word-meaning${word.example ? "" : " app-word-meaning-full"}`}
          >
            <div className="app-word-section-label">Meaning</div>
            <Spoiler>
              <div className="prose app-word-meaning-content">
        ...
        <footer className="app-word-card-footer">
          <div className="app-word-card-footer-meta">
            ...
            <strong>
              {new Date(word.reminder_time * 1000).toLocaleDateString()}
            </strong>
          </div>
          <Tooltip content="Mark as reviewed">
            <Button
              size="1"
              variant="ghost"
              className="app-word-review-button"
